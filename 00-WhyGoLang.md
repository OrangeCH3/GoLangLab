...
![解释性语言与编译型语言对比](./material/解释性语言与编译型语言对比.png)

同C,C++一样，Go语言也是编译型的语言，它直接将人类可读的代码编译成了处理器可以直接运行的二进制文件，执行效率更高，性能更好。

![常见编程语言的运行性能比较](./material/常见编程语言的运行性能比较.png)
...
![各种语言开发效率对比](./material/各种语言开发效率对比.png)
...
![使用GoLang的公司举例](./material/使用GoLang的公司举例.png)
